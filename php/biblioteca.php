  ...
  function MostrarLivro($cd){
    ...
    foreach($result as $row){
        echo '<tr>
                ...
                <td>'.$row['qtd'].'</td>
                <td>'.$row['estado'].'</td>
                <td><a href="?delete='.$row['cd'].'">(X)</a></td>
              </tr>';
    }
}
